...
prompt.get(
  ...
  (err, result) => {
    ...
    function updatePackage() {
      ...
      prompt.get(prompts, (updatePackageErr, updatePackageResult) => {
        // parse user responses
        // default values provided for fields that will cause npm to complain if left empty
        const responses = [
          {
            key: 'name',
            value: updatePackageResult.projectName || 'new-project',
          },
          {
            key: 'version',
            value: updatePackageResult.version || '0.1.0',
          },
          {
            key: 'author',
            value: updatePackageResult.author,
          },
          {
            key: 'license',
            value: updatePackageResult.license || 'MIT',
          },
          {
            key: 'description',
            value: updatePackageResult.description,
          },
